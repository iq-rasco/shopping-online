            ...
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="index.php"> <span>Store Clothes.</span>
                        </a>
                    </div>
                    <ul>
                        <li>+964 0770356718</li>
                        <li>sheet19990@gmail.com</li>
                        <li>Kirkuk, Iraq</li>
                    </ul>
                    <div class="footer-social">
                        <a href="https://www.facebook.com/iq.rasco0" target="_blank"><i class="fa fa-facebook"></i></a>
                        <a href="https://www.instagram.com/iq.rasco" target="_blank"><i class="fa fa-instagram"></i></a>
                        <a href="https://twitter.com/iq_rasco" target="_blank"><i class="fa fa-twitter"></i></a>
